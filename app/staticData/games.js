...
export default [{
    ...
    instructions: [{
        type: 'info',
        comment: "Open this URL to any device which can be visible to any player, example open this URL in tablet this would be our admin device",
    },
    {
        type: 'info',
    ...
    {
        type: 'info',
        comment: "Enter team names one by one and press add, every player would be in one team, minimum 2 teams are required for room to get created",
    },
    {
        type: 'info',
        comment: "Press Start",
