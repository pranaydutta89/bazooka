...
export default [
  {
    ...
    instructions: [
      ...
      },
      {
        type: "info",
        comment:
          "Enter room name, room name can be anything is specifies a group"
      },
      {
        type: "info",
        comment: "Press next"
      ...
      },
      {
        type: "info",
        comment:
          "Once the room and team has be created, copy the unique URL and share it to players"
      },
      {
        type: "info",
        comment:
          "Ask players to open the url and enter there name and select a team where they want to join"
      },
      {
        type: "info",
        comment:
          "Once players are joined, enter the time for which you want team to play ,default is 30 seconds"
      },
      {
        type: "info",
