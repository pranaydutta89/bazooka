      ...
      <div class="row">
        <div class="col teamRed">
          <div style="position:relative;">
            ...
            <h6>
              Taps (${_this.currentDifference <= 0 ? '+' : '-'}${Math.abs(_this.currentDifference)})
            </h6>
          </div>
        </div>
        ...
        <div class="col teamBlue">
          ...
          ${_this.isGameStarted && _this.currentDifference >= 0
            ? html`
                <div class="colorDiv" .style=${`width:${_this.currentWidth}%`}>
                  <h6>
                    Taps (+${Math.abs(_this.currentDifference)})
                  </h6>
                </div>
              `
            : ''}
          ${_this.isGameStarted && _this.currentDifference < 0
            ? html`
                <div class="colorDiv" style="width:0">
                  <h6>
                    Taps (-${Math.abs(_this.currentDifference)})
                  </h6>
                </div>
